...
export class World
{
		...
		if (worldScenePath !== undefined)
		{
			...
			loadingManager.onFinishedCallback = () =>
			{
				...
				Swal.fire({
					...
					footer: '<a href="https://study.163.com/course/courseMain.htm?courseId=1212491801&share=2&shareId=480000002203798" target="_blank">Three.js可视化企业实战WEBGL课</a><a href="https://space.bilibili.com/40018594" target="_blank">老陈打码</a>',
	...
	private generateHTML(): void
	{
		...
		$(`	<div id="loading-screen">
				...
				<h1 id="main-title" class="sb-font">老陈打码</h1>
				<div class="cubeWrap">
					<div class="cube">
